...
Minit varchar(20),
LName varchar(20),
SSN varchar(40) NOT NULL CHECK(SSN>'0') UNIQUE,
BDate varchar(50),
Address varchar(50) NOT NULL UNIQUE,
Sex varchar(50),
Salary int,
SuperSSN varchar(40) CHECK(SuperSSN>'0'),
DepNo varchar(34),
primary key (SSN),
...
DName varchar(30),
DepNo varchar(50),
MgrSSN varchar(50)NOT NULL CHECK(MgrSSN>'0'),
MgrSDate varchar(50),
primary key (DepNo),
foreign key (MgrSSN) references Employee
);

alter table Employee add foreign key (DepNo) references Dept;
...
foreign key (DepNo) references Dept
);
...
INSERT INTO dept VALUES ('Administration', 4, '987654321', '01-JAN-85');
INSERT INTO dept VALUES ('Headquarters', 1, '888665555', '19-JUN-71');
INSERT INTO dept VALUES ('Software',6,'111111100','15-MAY-1999');
INSERT INTO dept VALUES ('Hardware',7,'444444400','15-MAY-1998');
INSERT INTO dept VALUES ('Sales',8,'555555500','01-JAN-1997');
...
select * from employee;
select min(salary) from EMPLOYEE group by depno;
select avg(salary) as average_salary from employee group by depno ;
select avg(salary) as average_salary from employee where salary>40000 group by depno ;
select count(*) from employee where depno='6';
select fname from employee where fname like 'J%';
select count(pnumber) from project group by depno;
